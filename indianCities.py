def states_cities():
    ...
    SC_DATA = {
        ...
        "Chhattisgarh": ["Raipur", "Bilaspur", "Durg", "Bhilai", "Raigarh"],
        ...
        "Kerala": ["Thiruvananthapuram", "Kochi", "Kannur", "Kozhikode", "Thrissur"],
        "Madhya Pradesh": ["Bhopal", "Indore", "Jabalpur", "Gwalior", "Ujjain"],
        "Maharashtra": ["Mumbai", "Pune", "Nagpur", "Nashik", "Thane"],
        "Manipur": ["Imphal", "Thoubal", "Bishnupur", "Churachandpur", "Kakching"],
        "Meghalaya": ["Shillong", "Jowai", "Tura", "Nongstoin", "Williamnagar"],
        ...
        "Sikkim": ["Gangtok", "Gyalshing", "Jorethang", "Mangan", "Namchi"],
